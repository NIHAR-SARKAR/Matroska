/*! matroska beta 0.3 | (c)2017 Nihar Sarkar | www.niharsarkar.in/en/matroska/ | 1st jan 2017
// nihar.sarkar001@gmail.com
*/
...
function expcheck(id){
    ...
    else { $('valid[for="' + id + '"][type="expression"]').text("Undefined attribute !").attr("sn", "0"); console.log("Undefined attribute !"); }
}
...
/*require*/$('input[type="text"],input[type="password"]').blur(function(){
    ...
    }else{$('valid[for="'+id+'"][type="require"]').text("").attr("sn","1");}
});
/*---Expression----*/
...
/*Compare*/
 ...
 $('input[type="submit"],button[type="submit"]').click(function () {
     var id = $(this).attr("id"); 
     var f = $(this).attr("for"); 
     return ((id == undefined) ? pre : next)(id, f);
     //return false;
     console.log(id,f);
 });
 function next(id,f) {
     ...
     if (c > 0) { alert(err); return false; }
     else { alert("done");  return true; };
 }
 function pre(id,f){ console.log("Submit button attribute undefined !"); return false; }
